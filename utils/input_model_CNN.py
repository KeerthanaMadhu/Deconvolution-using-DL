...
def InputCNN(input_x, input_y, is_training,
          ...
          conv_featmap=[16,16,16,16],conv_kernel_size=[7,5,5,5],
    ...
    conv_layer_1 = CNN.conv_layer(input_x=conv_layer_0.output(),
    ...
    conv_layer_2 = CNN.conv_layer(input_x=conv_layer_1.output(),
    ...
    conv_layer_3 = CNN.conv_layer(input_x=conv_layer_2.output(),
    ...
    with tf.name_scope("loss"):
        ...
        mse_loss = tf.reduce_mean(
            tf.squared_difference(conv_layer_3.output(),input_y),
            name='mse')
        loss = tf.add(mse_loss, l2_norm * l2_loss, name='loss')

        tf.summary.scalar('Loss', loss)

    return conv_layer_3.output(), loss
